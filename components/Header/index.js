            ...
            >
              {!isBlog ? (
                <div className="grid grid-cols-1">
                  ...
                  <Button
                    onClick={() => window.open("mailto:arifulamindu@gmail.com")}
                  >
                    Contact
                  </Button>
                </div>
                ...
                <div className="grid grid-cols-1">
                  ...
                  {showResume && (
                    <Button
                      onClick={() => (window.open("/Resume_Md_Ariful_Amin.pdf"))}
                    >
                      Resume
                    </Button>
                  )}
      ...
      >
        ...
        {!isBlog ? (
          <div className="flex">
            ...
            <Button onClick={() => window.open("mailto:arifulamindu@gmail.com")}>
              Contact
            </Button>
